  ...
  <div class="min-h-screen flex items-center justify-center bg-gray-100 py-12">
    <div class="max-w-md w-full bg-white rounded-xl shadow-lg p-8">
      <div class="text-center mb-8">
        <h1 class="text-3xl font-bold text-gray-800">Registrar</h1>
        <p class="text-gray-600 mt-2">Crie sua conta gratuita</p>
      </div>
      ...
      <form @submit.prevent="handleRegister" class="space-y-6">
        ...
        <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4 text-sm text-yellow-800">
          <strong>Aviso:</strong> Este sistema utiliza Inteligencia Artificial para geracao de conteudo. 
          Revise sempre as questoes geradas antes do uso academico.
        </div>
